  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center px-4 lg:px-0">
        <div className="flex flex-col justify-center items-center py-20 pt-10 pb-10 sm:pt-20 sm:pb-30  lg:flex-row w-full h-full w-full gap-20 lg:gap-40">
          {/* Texto Informativo */}
          <div className="flex flex-col justify-center md:w-[40em] lg:w-[45em]">
            ...
            <div className="font-roboto text-[#555555dc] leading-relaxed space-y-6 text-2xl sm:text-xl lg:text-3xl px-2 lg:px-0">
              <p>
            ...
            >
              {[
                ...
                <AccordionItem key={index} value={`item-${index}`}>
                  <AccordionTrigger className="text-2xl lg:text-4xl [&_svg]:w-5 [&_svg]:h-5">
                    {item.title}
                  </AccordionTrigger>
                  <AccordionContent className="font-roboto text-[#2b2a2adc] leading-relaxed pl-4 text-base text-2xl lg:text-3xl">
                    {item.content}
                  </AccordionContent>
                </AccordionItem>
              ))}
